      ...
      <div style={{ maxWidth: 1060, margin: "0 auto", padding: "0 20px", display: "flex", justifyContent: "space-between", alignItems: "center", height: 52 }}>
        ...
        {!isPwa ? (
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            {["home","enterprise","agentur","brain","newsroom","readiness","engine","legal","assess","results","checkout","skills","path"].includes(screen) && ["Enterprise", "Agentur", "Brain"].map(i => (
